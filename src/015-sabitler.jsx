...
const SURUM_GECMISI = [
  { surum: "1.478.0", tarih: "26.09.2026",
    eklenen: [],
    degisen: [],
    duzeltilen: ["Alış/satış fişinde ve siparişte rengi boş kayıtlı ya da hiç varyantı olmayan renksiz üründe renk kutusu açılıp miktar girilemiyordu — artık renk sorulmuyor, miktar kutusu doğrudan açılıyor"] },
  ...
  { surum: "1.475.0", tarih: "26.09.2026",
    eklenen: [
      ...
      "Finans Raporu ▸ Nakit Akışı: kasa+banka başlangıcı, vadesine göre çek girişi, alacak tahsili, çek ödemesi, borç ödemesi; haftalık/aylık, birikimli nakit ve en düşük nokta",
      "Finans Raporu ▸ Maliyet Farkı: üretim başına kart maliyeti ile gerçekleşen (hammadde + işçilik), hammadde bazında miktar farkı ve reçete dışı malzeme",
    ],
    degisen: [],
    duzeltilen: [] },
  { surum: "1.474.0", tarih: "26.09.2026",
    eklenen: [],
    degisen: ["Stok matrislerinin köşe başlığı eksene göre: renk ve beden varsa 'Renk \\ Beden', yalnız biri varsa 'Renk' ya da 'Beden', hiçbiri yoksa boş"],
    duzeltilen: ["Üretim kartındaki çıkış matrisinde de 'Standart' yazmıyor"] },
  { surum: "1.473.0", tarih: "26.09.2026",
    eklenen: [],
    degisen: [],
    duzeltilen: ["Ürün kartı özetinde bedensiz renkli üründe '2 renk × 0 beden' yerine '2 renk'"] },
  { surum: "1.472.0", tarih: "26.09.2026",
    eklenen: [],
    degisen: [],
    duzeltilen: ["Renk/beden seçilmeyen üründe yeni ürün formu matrisinde, ürün kartında ve kart fiş matrislerinde 'Standart' yazmıyor (özet: 'tek stok kalemi')"] },
  { surum: "1.471.0", tarih: "26.09.2026",
    eklenen: ["Başka malzeme tipinin rengi yazınca bulunuyor ve seçilince iki tipin ortak rengi oluyor; ortak renkler etiketli"],
    degisen: ["Hammadde açarken/ürün kartında seçilen renkler ürünün malzeme tipine bağlanıyor (genel renkler dahil)", "Renk listesinde önce bu tipin renkleri, sonra genel renkler"],
    duzeltilen: [] },
